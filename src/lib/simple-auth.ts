...
// // // /**
// // //  * registerNewUser
// // //  * [SCR-954]: THE GENESIS PULSE
// // //  * [SCR-984]: Enforcement - Public registration is locked to role: 'traveler'.
// // //  * Agents and Carriers must be recruited via Admin Citadel.
// // //  */
...
// // //   phone: string,
// // //   name: string,
// // //   _ignoredRole: string, // Role input is ignored for public safety
...
// // //     // [SCR-984]: ATOMIC TRAVELER SEAL
// // //     // Public signup strictly creates travelers.
// // //     batch.set(userRef, {
// // //       uid: user.uid,
// // //       id: user.uid,
// // //       phoneNumber: phone,
...
// // //       role: "traveler", // Hardcoded for security
...
// //  * registerNewUser
// //  * [SCR-954]&#58; THE GENESIS PULSE
// //  * [SCR-984-REV]&#58; Public registration preserves the selected role for traveler/carrier flows.
// //  * Agents and elevated staff still require Admin Citadel.
// //  */
// // export async function registerNewUser(
// //   db: Firestore,
// //   auth: Auth,
...
// //     const batch = writeBatch(db);
// //     const userRef = doc(db, "users", user.uid);
// //     const safeRole = requestedRole === "carrier" ? "carrier" : "traveler";
...
//     // [SCR-1002-FIX]: لو في anonymous session نشطة من checkUserExistence،
//     // نعمل sign out منها أولاً عشان نقدر ننشئ email/password account جديد
//     if (email && password) {
