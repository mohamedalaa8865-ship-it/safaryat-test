      ...
      <Card className={cn(
        ...
        <div className="p-4 space-y-4 bg-[#200a0f89]">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="ghost" size="icon"
              className={cn("h-9 w-9", (hasBookings || isDeparted) ? "text-muted-foreground opacity-40 cursor-not-allowed" : "text-blue-600")}
              onClick={() => !hasBookings && !isDeparted && onEdit(trip)}
