...
import { ChevronRight, MessageSquare, ShieldCheck, CheckCircle2, Clock } from 'lucide-react';
...
export function TicketHeader({ tripId, carrierId, tripStatus }: TicketHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/90 backdrop-blur-xl border-b border-primary/10 shadow-2xl overflow-hidden">
