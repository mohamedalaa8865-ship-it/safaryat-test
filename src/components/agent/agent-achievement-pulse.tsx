...
export function AgentAchievementPulse({
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-6 pt-6 text-right relative z-10">
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="flex items-center gap-2 justify-end">
              <Badge variant="outline" className="text-[8px] font-black bg-primary/5 text-primary border-primary/10 px-2 py-0">وكيل سيادي</Badge>
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">لوحة الإنجازات الميدانية</p>
            </div>
          </div>
        ...
        <div className="p-5 bg-muted/30 rounded-3xl border border-dashed text-right shadow-inner hover:bg-muted/50 transition-colors">
          <span className="text-[9px] text-muted-foreground font-black uppercase flex items-center gap-1 justify-end">
        ...
        <div className="pt-2 flex justify-end items-center border-t border-white/5">
          <span className="text-[8px] font-bold text-muted-foreground italic">يتم تحديث العداد آلياً من السجل التاريخي الموحد (SSOT).</span>
        </div>
      </CardContent>
    </Card>
  );
