...
// // // // //                             <p className="text-sm md:text-lg font-black text-muted-foreground uppercase flex items-center gap-1"><Clock className="h-3 w-3" /> {t('time')} </p>
...
// // // // // //                         </div>
// // // // // //                     )}
// // // // // //                     {/* بطاقة معلومات الرحلة: رقم الرحلة + وقت الانطلاق + التاريخ */}
// // // // // //                     <div className="grid grid-cols-3 gap-2 text-center">
// // // // // //                         <div className="p-2 bg-background/50 rounded-xl border border-primary/20 space-y-1 shadow-sm">
// // // // // //                             <p className="text-[10px] md:text-xs font-black text-muted-foreground uppercase">{t('flightNumber')}</p>
// // // // // //                             <p className="font-mono font-bold text-sm text-white">{displayTrip.id.slice(-6).toUpperCase()}</p>
// // // // // //                         </div>
// // // // // //                         <div className="p-2 bg-background/50 rounded-xl border border-primary/20 space-y-1 shadow-sm">
// // // // // //                             <p className="text-[10px] md:text-xs font-black text-muted-foreground uppercase">{t('departureTime')}</p>
// // // // // //                             <p className="font-bold text-sm">{formatDate(displayTrip.departureDate, 'hh:mm a', locale)}</p>
// // // // // //                         </div>
// // // // // //                         <div className="p-2 bg-background/50 rounded-xl border border-primary/20 space-y-1 shadow-sm">
// // // // // //                             <p className="text-[10px] md:text-xs font-black text-muted-foreground uppercase">{t('date')}</p>
// // // // // //                             <p className="font-bold text-sm">{formatDate(displayTrip.departureDate, 'dd/MM/yyyy', locale)}</p>
// // // // // //                         </div>
// // // // // //                     </div>
// // // // // //                     <div className="grid grid-cols-1 gap-2">
// // // // // //                         {booking.passengersDetails?.map((pax, idx) => (
...
// // // // // //                                     {pax.phone && (
// // // // // //                                         <a
// // // // // //                                             href={`tel:${pax.phoneCountryCode || ''}${pax.phone}`}
// // // // // //                                             className="font-mono text-sm text-primary/80 hover:text-primary ltr"
// // // // // //                                             dir="ltr"
// // // // // //                                         >
// // // // // //                                             {pax.phoneCountryCode ? `${pax.phoneCountryCode} ${pax.phone}` : pax.phone}
// // // // // //                                         </a>
// // // // // //                                     )}
// // // // // //                                 </div>
// // // // // //                                 <Badge variant="outline" className="font-mono text-[14px] text-black gap-1 px-3 bg-[#A18E64]">
...
//     const { request: transferRequest } = useBookingTransferPassenger(booking.id);
