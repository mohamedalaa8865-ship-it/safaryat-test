...
export function PrintableTicket({ isOpen, onOpenChange, trip, booking, carrier, isAdminView }: PrintableTicketProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-3xl max-h-[95vh] flex flex-col p-0 overflow-hidden border-0 pt-5  shadow-2xl">
                <div className="p-4 border-b bg-background flex justify-between items-center no-print">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={handlePrint} size="sm" className="gap-2 bg-[#307380] text-white hover:bg-turquoise/90 font-bold">
                ...
                <div className="flex-1 min-h-0 bg-white  overflow-y-auto print-manifest-container relative">
                    ...
                    <div className="p-8 space-y-8 max-w-2xl mx-auto text-black smart-ticket-print relative z-10">
                        ...
                        <div className="flex justify-between items-start border-b-4 border-black pb-4">
                            <div className="space-y-1 text-right">
                                <h1 className="text-4xl text-black tracking-tighter italic">SAFAR GATE</h1>
                        ...
                        <div className="text-center py-6  border-b border-black/10">
                            ...
                            {arrivalDate && (
                                <div className="mt-4 flex items-center  justify-center gap-4 p-4 rounded-full border border-black/5">
                                    <span className="text-xs font-bold">{formatDate(trip.departureDate, 'hh:mm a', locale)}</span>
                                    <div className="flex-1 flex items-center gap-1 pb-2 border-b-2 border-dashed border-black/20 relative min-w-[100px]">
                        ...
                        <div className="pt-10 border-t-2 border-black/10 space-y-6">
                            ...
                            <div className="flex items-center justify-between opacity-30 grayscale filter">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="text-[9px] font-bold text-black  leading-none uppercase">
                                        Safar Gate<br />Sovereign Verified
                                    </div>
                                </div>
                                <p className="text-[9px] font-bold text-black">TIMESTAMP: {mounted ? currentTimestamp : '...'}</p>
                            </div>
                        </div>
