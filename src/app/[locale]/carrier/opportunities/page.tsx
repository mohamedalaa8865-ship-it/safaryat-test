...
export default function MarketRequestsPage() {
  ...
  // ✅ [FIX]: جلب رحلة الناقل النشطة — المصدر الحقيقي لـ carrierTripId
  ...
  const handleSendOffer = useCallback(async (
    ...
    try {
      ...
      const offerRef = doc(collection(firestore, 'offers'));
      // ✅ [FIX]: carrierTripId من رحلة الناقل النشطة — مش من رحلة المسافر
      const effectiveCarrierTripId = (activeCarrierTrip as any)?.id || null;
