...
//   Shield, Zap, DollarSign, Star, Users, CheckCircle2,
//   ArrowLeft, ArrowRight, Eye, AlertCircle, Loader2,
//   CircleDot, Mail, Phone, Send, EyeOff, MenuIcon, Bus
// } from 'lucide-react';
...
// // ✅ Lazy load heavy images — مش محتاجة في أول render
// import ourGoalsImg from '../../../public/imgi_5_opt.webp'; // ✅ optimized WebP
// import ourVisionImg from '../../../public/imgi_4_opt.webp'; // ✅ optimized WebP
// import emailImg from '../../../public/imgi_6_opt.webp'; // ✅ optimized WebP

// const LOGO_URL = '/logo.webp'; // ✅ optimized WebP (3KB vs 815KB)

// // ✅ useCountUp — بدون تغيير
// function useCountUp(target: number, duration = 2000) {
//   const [count, setCount] = useState(0);
//   const [started, setStarted] = useState(false);
//   const ref = useRef<HTMLDivElement>(null);
...
// // ✅ Animated section — بدل framer-motion استخدم CSS + IntersectionObserver
...
//               {/* ✅ lazy loading للصور البعيدة عن الـ viewport */}
...
//               <div className="space-y-2">
//                 <Label htmlFor="email-secret">{ta('auth.email')}</Label>
//                 <Input id="email-secret" type="email" value={email} onChange={e => setEmail(e.target.value)}
//                   required dir="ltr" disabled={isLoading} className="font-mono" autoComplete="email" />
//               </div>
//               <div className="space-y-2">
//                 <Label htmlFor="password-secret">{ta('auth.password')}</Label>
//                 <div className="relative">
...
//               </Button>
//               <Button type="submit" disabled={isLoading} className="min-w-[120px]">
//                 {isLoading ? <Loader2 className="animate-spin h-4 w-4" aria-hidden="true" /> : ta('admin.loginAdmin')}
//               </Button>
//             </DialogFooter>
//           </form>
//         </DialogContent>
