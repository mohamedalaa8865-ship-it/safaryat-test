...
// //  * @description THE STERILIZED BOOKING CONFIRMATION (REINFORCED - SC-806 V5.2)
// //  * [SC-806 V5.2]: Enforced writeBatch for Atomic Token consumption and Booking creation.
// //  * Uses the Sovereign Error Dictionary for consistent feedback.
// //  */
...
// //     if (!user?.uid) throw new Error('AUTH_REQUIRED'); // ← أضف ده
...
// //         carrierTripId: tokenData.carrierTripId || null, // ✅ جديد
// //         userId: user?.uid,
...
// //       // 2. تعليم التوكن كمستخدم
// //       batch.update(tokenRef, { status: 'used', usedAt: serverTimestamp() });

// //       // 3. تقليل المقاعد وإضافة الـ booking للـ trip
...
// //               });
// //             } */
// //       // 4. ✅ تحديث user profile بـ activeBookingId عشان الـ history page يشوف الحجز
// //       if (user?.uid) {
// //         const userRef = doc(firestore, 'users', user.uid);
// //         batch.update(userRef, {
// //           activeBookingId: bookingRef.id,
// //           activeIntentId: null, // ✅ امسح الـ intent عشان مش يتعارض
// //           updatedAt: serverTimestamp(),
// //         });
// //       }

// //       // 5. إرسال إشعار للناقل
...
// //         }, { merge: true });
// //       } catch (e) {
// //         console.warn('Could not join group chat:', e);
// //       }
...
// //           {/* <p className="text-muted-foreground">تم إرسال طلبك للناقل. يمكنك متابعة الحالة في لوحة التحكم.</p> */}
// //           <Button className="w-full" onClick={() => router.push(`/${locale}/history`)}>{t('gotoReq')}</Button>
// //           {/* <Button variant="outline" className="w-full" onClick={() => router.push(`/${locale}/dashboard`)}>العودة للرئيسية</Button> */}
// //         </div>
// //       )}
...
// //           <Button className="w-full" onClick={() => router.push(`/${locale}/dashboard`)}>العودة للرئيسية</Button>
// //         </div>
// //       )}
...
// //       // 3. تقليل المقاعد من رحلة الناقل الأصلية (carrierTripId) عند دفع العربون
// //       if (tokenData.carrierTripId) {
// //         const carrierTripRef = doc(firestore, 'trips', tokenData.carrierTripId);
// //         batch.update(carrierTripRef, {
// //           availableSeats: increment(-passengers.length),
