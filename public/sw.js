...
// // ============================================================
// // SERVICE WORKER — Firebase Messaging ONLY
// // PWA Caching is handled by next-pwa (workbox) automatically.
// // DO NOT add install/activate/fetch handlers here — they will
// // conflict with the auto-generated workbox sw from next-pwa.
// // ============================================================
...
//   const notificationTitle = payload.notification?.title || "سفريات";
//   const notificationOptions = {
//     body: payload.notification?.body || "",
//     icon: "/icons/icon-192x192.png",
//     badge: "/icons/icon-72x72.png",
...
// المسار: /public/sw.js
//
// ⚠️ هذا الملف مسؤول عن PWA Caching فقط
// Firebase Messaging = firebase-messaging-sw.js فقط
//
// السبب: لو حطيت Firebase هنا وفي firebase-messaging-sw.js
// هيتعملوا تسجيلين مختلفين → تعارض → مفيش إشعارات
// ============================================================

// ── PWA Caching (Offline Support) ──
const CACHE_NAME = "safaryat-pwa-v2";
...
self.addEventListener("fetch", (event) => {
  ...
  // Navigation و API: Network-first دايماً
  if (request.mode === "navigate" || request.url.includes("/api/")) {
